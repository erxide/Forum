...
func Connectefootball(w http.ResponseWriter, r *http.Request) {
	...
	rows, err := forum.Bd.Query("SELECT id, theme, titre, description, cree_le, cree_par, likes, dislikes FROM Postes WHERE theme = 'football' ORDER BY id DESC;")
